...
export const strings = {
  ...
  homeDue: (n: number) => `${n} ${n === 1 ? 'word is' : 'words are'} ready for review.`,
  homeCaughtUp: "You're caught up. A new lesson is a good idea.",
  homeFirst: "Let's learn some German.",
  lessonsCompanion: 'Pick a lesson. Short and often beats long and rare.',
  companionSetting: 'Milo',
  companionChoice: {
    full: 'With what he says',
    quiet: 'Picture only',
    still: 'Hold still',
    off: 'Hidden',
  } as const,
